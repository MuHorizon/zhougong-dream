/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8eb9fb30b0d490f7667522db0d0d6984)
// Runtime types generated with workerd@1.20260916.1 2026-09-17 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	AI_MODELS: "qwen3.7-flash-2026-07-15,qwen3.7-flash,qwen3.8-max,qwen3.8-2.4t-a95b,qwen3.8-27b,qwen3.8-flash,qwen3.8-max-0902";
	AI_API_URL: string;
	AI_API_KEY: string;
	AI_MODEL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODELS" | "AI_API_URL" | "AI_API_KEY" | "AI_MODEL">> {}
}
